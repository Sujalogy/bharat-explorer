...
export const maharashtraDistricts: Region[] = [
  {
    id: "mumbai",
    name: "Mumbai",
    path: "M 50,350 L 80,340 L 90,380 L 60,395 Z",
    centroid: [70, 365],
  },
  {
    id: "pune",
    name: "Pune",
    path: "M 100,320 L 160,310 L 175,360 L 120,380 Z",
    centroid: [135, 345],
  },
  {
    id: "nagpur",
    name: "Nagpur",
    path: "M 280,280 L 340,270 L 355,320 L 295,340 Z",
    centroid: [315, 305],
  },
  {
    id: "nashik",
    name: "Nashik",
    path: "M 120,260 L 180,250 L 195,300 L 135,320 Z",
    centroid: [155, 285],
  },
  {
    id: "thane",
    name: "Thane",
    path: "M 70,310 L 115,300 L 125,345 L 80,360 Z",
    centroid: [95, 330],
  },
  {
    id: "aurangabad",
    name: "Aurangabad",
    path: "M 175,290 L 240,280 L 255,330 L 190,350 Z",
    centroid: [210, 315],
  },
  {
    id: "solapur",
    name: "Solapur",
    path: "M 160,370 L 225,360 L 240,415 L 175,430 Z",
    centroid: [195, 395],
  },
  {
    id: "kolhapur",
    name: "Kolhapur",
    path: "M 100,420 L 160,410 L 175,460 L 115,475 Z",
    centroid: [135, 445],
  },
];
